  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0D1117] px-4">
      <div className="bg-[#161b22] border border-white/10 backdrop-blur-lg rounded-2xl shadow-xl w-full max-w-md p-8 space-y-6">
        ...
        <p className="text-sm text-gray-400 text-center">Sign up to start using LucidView</p>
        ...
        <form className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              id="password"
              placeholder="••••••••"
              className="w-full py-2 px-4 mb-2 rounded-lg bg-[#0D1117] border border-white/10 text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
